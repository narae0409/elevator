...
urlpatterns = [
    ...
    path('main/number/all/', views.index_NumberMain_A, name='idx_NBMA'),
    path('api/graph/all', views.ElvtAPIVIEW_A.as_view(), name="idx_APIA"),
    ...
    path('graph/all/', views.index_GraphA, name='idx_GPA'),
    path('graphic/', views.index_Graphic, name='idx_GRP'),
    path('api/predict/', views.eAPIView.as_view(), name='predict'),
